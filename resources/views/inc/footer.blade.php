                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="footer__text-widget">
                            ...
                            <ul class="footer__widget-info">
                                <li><span class="fa fa-map-marker"></span> #39; St. CKD10, Khan Dangkor, <br />
                                Phnom Penh, Kingdom of Cambodia.</li>
                                <li><span class="fa fa-mobile"></span> +855 77 34 33 03 | 96 73 62 510</li>
                                <li><span class="fa fa-headphones"></span> nhosting@gmail.com</li>
                            </ul>
                        </div>
                    </div>
                </div>
